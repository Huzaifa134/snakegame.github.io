...
import sound from "../music/move.mp3";
...
function gameEngine() {
  ...
  //   if you have eaten food , increnment the score and regeneratee the food
...
if (highscore === null) {
  highscoreval = 0;
  localStorage.setItem("highsscore", JSON.stringify(highscoreval));
} else {
